      ...
      {/* header content */}
        <div className="h-[5.6rem] flex-row justify-between items-center bg-white flex sm:items-center sm:flex sm:flex-wrap ">
          ...
          <div className="fill-primary text-primary w-[8.6rem] h-[1.7rem] flex items-baseline gap-[0.6rem] order-1 basis-[25%] hover:cursor-pointer mb-[20px] md:basis-[25%] md:pl-[30px] sm:order-1 sm:basis-[30%] sm:mt-[25px] sm:pl-[20px]">
            {/* logo h1 */}
            <h1 className="text-primary text-center font-Inter text-[2.2rem] font-bold leading-normal m-0 bg-logo-text-background pl-[9.5px] pr-[9.5px] pt-[0px] pb-[0px] rounded-[10px] md:text-[1.7rem] sm:text-[1.7rem]">M</h1>
            <img className="h-[1.7rem] w-[8.6rem] md:h-[1.5rem] md:w-[5.6rem] sm:h-[1.5rem] sm:w-[5.6rem] " src="./icons/megamart.svg" alt="MegaMart" />
          </div>
          <SearchBar
